...
1. prep_multimodal.py
2. train_early_fusion.py # Train joint multimodal early-fusion model
3. train_late_fusion.py # Train separate text/audio models for late fusion
4. eval_late_fusion.py # Evaluate trained text/audio/fusion models
